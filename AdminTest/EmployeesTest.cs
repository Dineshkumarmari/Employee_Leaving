...
//            var exception = controller.GetbyId(3);
...
//            Listobj.Add(obj);
//            var mockService = new Mock<ILeaving>();
//            mockService.Setup(x => x.AddEmployee(It.IsAny<Employee>())).Returns(obj);
//            var controller = new LeavingController(mockService.Object);
...
//            var mockService = new Mock<ILeaving>();
//            mockService.Setup(x => x.GetbyId(It.IsAny<int>())).Returns(obj);
//            mockService.Setup(x => x.UpdateEmp(It.IsAny<Employee>())).Returns(obj);
//            var controller = new LeavingController(mockService.Object);
...
//            var mockService = new Mock<ILeaving>();
//            mockService.Setup(x => x.GetbyId(It.IsAny<int>())).Returns(obj);
//            mockService.Setup(x => x.DeleteEmployee(It.IsAny<int>())).Returns(obj);
//            var controller = new LeavingController(mockService.Object);

//            var exception = controller.DeleteEmp(110);
