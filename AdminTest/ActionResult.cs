...
namespace AdminTest
{
    public class ActionResult
    {
        ...
        public void Accept_okResult()
        {
            ...
            mockservice.Setup(x => x.AcceptLeave(It.IsAny<int>(),It.IsAny<int>())).Returns(msg);
            var controller = new LeavingController(mockservice.Object);

            var okresult = controller.AcceptLeave(3,2);
        ...
        public void Accept_NotFoundResult()
        {
            ...
            var exception = Assert.Throws<Exception>(() => controller.AcceptLeave(1,2));
        ...
        public void Reject_okResult()
        {
            ...
            var mockservice = new Mock<ILeaving>();
            mockservice.Setup(x => x.Getbyid(It.IsAny<int>())).Returns(obj);
            mockservice.Setup(x => x.RejectLeave(It.IsAny<int>(), It.IsAny<int>())).Returns(msg);
            var controller = new LeavingController(mockservice.Object);

            var okresult = controller.RejectLeave(3,2);
        ...
        public void Reject_NotFoundResult()
        {
            ...
            var exception = Assert.Throws<Exception>(() => controller.RejectLeave(1,2));
